...
private:
	...
	//......................................................................................................................
	queue<char, UART_RX_BUFFER_SIZE> LINE;
	GcodeStatus state;
	GcodeValues value;
	size_t real_time_status;
public:
	size_t Proccess_Gcode(UART&);
	void Ignore_Spaces_And_Comments(UART&);
	bool Read_Letter_And_Number(char& CH, Number& N);
	size_t Get_Status() const { return real_time_status; }
	friend ostream& operator<< (ostream&, const GCodeParser&);
	
	//.....................................................
	// Estas despues vuelan!...............................
	//.....................................................
	void ShowFiltered();
	void PutInBuffer(const char& ch);
	void PutInBuffer(const char* ch);
	//.....................................................
};
